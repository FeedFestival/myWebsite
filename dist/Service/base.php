...
$username = "id1570128_simionescudani07";					// $username = "id1570128_simionescudani07";		// "root"
$password = "parola_Fire4Test";						// $password = "parola_Fire4Test";					// ""
$dbName = "id1570128_game_crib";				// $dbName = "id1570128_game_crib";					// "game_crib"
...
header("Access-Control-Allow-Headers: Content-Type, Authorization, X-Requested-With, origin, authorization, accept, client-security-token");
